...
- **IDOR 스캔**: 시간 제한이 걸린 미공개 교안도 자동 탐지 및 다운로드
...
1. SSO 로그인으로 세션 획득
2. 강의 페이지에서 공개된 파일 링크 수집
3. IDOR 스캔으로 시간 제한된 비공개 파일 추가 탐지
4. `download.php` 엔드포인트로 원본 PDF 직접 다운로드
5. 세션 만료 시 자동 재로그인 후 재시도
